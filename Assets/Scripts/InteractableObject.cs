...
public class InteractableObject : MonoBehaviour {
    ...
    void UpdateState(bool init)
    {
        ...
        else if (d == Description.Door)
        {
            ...
            {
                Transform side_A = transform.parent.Find("Side_A").GetComponent<Transform>();
                Transform side_B = transform.parent.Find("Side_B").GetComponent<Transform>();

                if (objectType == 1)
                {
                    door_1 = transform.parent.Find("Door_1").gameObject;
                    door_2 = transform.parent.Find("Door_2").gameObject;
                }
        ...
        if(d == Description.Door)
        {
            ...
            if(currentState == 0)
            {
                ...
                if (Vector3.Distance(playerTransform.position, side_A.position) < Vector3.Distance(playerTransform.position, side_B.position))
                {
                    ...
                    transform.parent.Find("KeyholePos_B/Camera_B").gameObject.SetActive(true);
                }
                ...
                else
                {
                    ...
                    transform.parent.Find("KeyholePos_A/Camera_A").gameObject.SetActive(true);
                }
            }
        }
    }
